...
- Best badge medal (all modes, wins only): 🥇 if finished on or before wave 6 while staying within the 32 grain loss target; 🥈 if finished on/before wave 6 but over the grain target, or after wave 6 while staying within the grain target; otherwise 🥉. The same medal shows on the victory score summary.
