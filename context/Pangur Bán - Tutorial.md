...
20. Once all cats have taken their turn it’s the mice turn to play
    1. Mice can move or attack cats first
       1. Show 33 attacking 31
       2. Show B5 moving left into shadow
       3. Stunned mice don’t take a turn
    2. Then if a mouse is in shadow, they eat grain and grow bigger
    3. Once all mice in barn have finished their move, mice that are not deterred enter barn through entrance
    4. Note: new mice can be appended to uninterrupted mice line
    5. Once placed, the next cat turn begins
21. The cats win the game when all mice are killed in barn and they deter all incoming mice.
